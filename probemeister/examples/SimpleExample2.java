/*
 * @(#)SimpleExample.java	1.24 01/01/29
 *
...
public class SimpleExample2 extends JPanel {
    ...
    //static final int OBJSPROBECOUNT= 11;
	...
	RadioListener myListener = new RadioListener(this);
    ...
    class RadioListener implements ActionListener {  
        SimpleExample2 parent;

        public RadioListener(SimpleExample2 _parent) {
            super();
            parent = _parent;
        }
	...
	public void actionPerformed(ActionEvent e) {
        ...
        parent.instrumentMe("This is a test string argument", lnfName, x++);

//        com.objs.dasada.siena.geoworlds.probes.ProbeManager.executionErrorEvent(lnfName, "Button", 
//                    "Current Thread", "Exception", "exceptionString");        
    ...
    public void instrumentMe(String s, String bName, int x) {
        try {
            System.out.println("Ping! ("+x+")"+s+" -- you pressed: "+bName);
        } catch (Exception e) {
    ...
    public void updateState() {
	 ...
	 if (lnfName.indexOf(metal) >= 0) {
	     ...
	     System.err.println("SimpleExample2 is using an unknown L&F: " + lnfName);
	 }
    }
...
/*
    ...
    try {            
        Class.forName("fooClass").getDeclaredMethod("gooMethod", null).invoke(null, null);
    } catch (Exception e) {
        e.printStackTrace();
    }
*/

	SimpleExample2 panel = new SimpleExample2();
	
	frame = new JFrame("SimpleExample2");
